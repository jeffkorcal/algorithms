...
// If node value is less than target save node value and move to the right
// If node value is greater than or equal to target move to the left
// NOTE: The while loop breaks when the node is null
